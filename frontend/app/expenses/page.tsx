...
const Expenses = () => {
    ...
    const aggregatedData: AggregatedDataItem[] = useMemo(() => {
        const filter: AggregatedData = expenses.filter((data: ExpenseByCategorySummary) => {
    ...
    if (isError || !expenses)
        return <div className="text-red-500 py-4 text-center">failed fetching expenses </div>
